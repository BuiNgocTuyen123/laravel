...
class CateoryProduct extends Controller
{
    ...
    public function show_category_home($category_id){
        ...
        $category_by_id = DB::table('tbl_product')->join('tbl_cateory_product','tbl_product.category_id','=','tbl_cateory_product.category_id')
        ->where('tbl_product.category_id',$category_id)->get();
        $category_name = DB::table('tbl_cateory_product')->where('tbl_cateory_product.category_id',$category_id)->limit(1)->get();
